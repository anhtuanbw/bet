...
public class FieldDifferentValidator implements ConstraintValidator<FieldDifferent, Object> {
    ...
    @Override
    public void initialize(final FieldDifferent constraintAnnotation) {
    ...
    public boolean isValid(final Object value, final ConstraintValidatorContext context) {
        try {
            ...
            if (!matched) {
                ...
                context.buildConstraintViolationWithTemplate(message).addPropertyNode(secondField)
