...
public class SecurityConfig extends WebSecurityConfigurerAdapter implements EnvironmentAware {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.exceptionHandling()
            ...
            .antMatchers("/api/matches/create-match").authenticated()
            .antMatchers("/api/matches/getMatch/*").authenticated()
            .antMatchers("/api/matches/update-score").authenticated()
            .antMatchers("/api/matches/competitors/*").authenticated()
            .antMatchers("/api/matches/rounds/*").authenticated()
            ...
            .antMatchers("/api/tournaments/getById").hasRole(User.Role.ADMIN.name())
